...
+ `go get github.com/scholar-ink/go-mysql-elasticsearch`, it will print some messages in console, skip it. :-)
+ cd `$GOPATH/src/github.com/scholar-ink/go-mysql-elasticsearch`
+ `make`
